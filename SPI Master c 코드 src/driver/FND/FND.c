...
void FND_Init()
{
	// GPIO 占쏙옙占쏙옙, GPIOA0,1,2,3 COM 占쏙옙트占쏙옙 占쏙옙占쏙옙퓸占� 占쏙옙占쏙옙
	GPIO_SetMode(GPIOA, FND_COM_DIG_1|FND_COM_DIG_2|FND_COM_DIG_3|FND_COM_DIG_4, OUTPUT);
	// GPIO 占쏙옙占쏙옙, GPIOB seg abcdefg,dp占쏙옙 占쏙옙占쏙옙퓸占� 占쏙옙占쏙옙.
...
void FND_DispDigit_1()
{
	...
	// data占쏙옙 占쌘몌옙占쏙옙 占싻몌옙.
	uint8_t digitData1 = fndNumData % 10; // 占쏙옙占쏙옙 占쌘몌옙
	FND_DispAllOff();
...
void FND_DispDigit_10()
{
	...
	// data占쏙옙 占쌘몌옙占쏙옙 占싻몌옙.
	uint8_t digitData10 = fndNumData / 10 % 10; // 占쏙옙占쏙옙 占쌘몌옙
	FND_DispAllOff();
...
void FND_DispDigit_100()
{
	...
	// data占쏙옙 占쌘몌옙占쏙옙 占싻몌옙.
	uint8_t digitData100 = fndNumData / 100 % 10; // 占쏙옙占쏙옙 占쌘몌옙
	FND_DispAllOff();
...
void FND_DispDigit_1000()
{
	...
	// data占쏙옙 占쌘몌옙占쏙옙 占싻몌옙.
	uint8_t digitData1000 = fndNumData / 1000 % 10; // 占쏙옙占쏙옙 占쌘몌옙
	FND_DispAllOff();
