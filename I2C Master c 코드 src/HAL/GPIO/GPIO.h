...
#define GPIOE_CR  (*(uint32_t *) (GPIOE_BASE_ADDR + 0x00))
#define GPIOE_IDR (*(uint32_t *) (GPIOE_BASE_ADDR + 0x04))
#define GPIOE_ODR (*(uint32_t *) (GPIOE_BASE_ADDR + 0x08))
...
void GPIO_SetMode(GPIO_Typedef_t *GPIOx, uint32_t GPIO_Pin, int GPIO_Dir); // 세미콜론 꼭 붙여야 한다!!!
