...
##Pmod Header JXADC       ###################### I2C SLAVE ########################
set_property -dict { PACKAGE_PIN J3   IOSTANDARD LVCMOS33 } [get_ports {scl}];#Sch name = XA1_P
set_property -dict { PACKAGE_PIN L3   IOSTANDARD LVCMOS33 } [get_ports {sda}];#Sch name = XA2_P
